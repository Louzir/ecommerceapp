    ...
    builder: (context) => Container(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            const TextFrave(text: 'Update profile picture', fontWeight: FontWeight.w500, fontSize: 16),
            ...
            SizedBox(
              ...
              child: TextButton(
                ...
                style: TextButton.styleFrom(
                  foregroundColor: Colors.grey, padding: const EdgeInsets.only(left: 0, top: 10, bottom: 10)
                ),
                child: const Align(
